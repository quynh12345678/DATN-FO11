            ...
            <tbody>
              <tr>
                <td className="left-section-bill">
                  ...
                  <p>
                    <FontAwesomeIcon icon={faUser} /> Họ và tên: Phạm Vang
                  </p>
                  <p>
                    <FontAwesomeIcon icon={faPhone} /> Số điện thoại: 0332702119
                  </p>
                  <p>
                    <FontAwesomeIcon icon={faEnvelope} /> Email: vang@gmail.com
                  </p>
                </td>
                <td className="right-section-bill vehicle-info">
                  <div className="vehicle-info-content">
                    <div>
                      ...
                      <p>
                        <FontAwesomeIcon icon={faUser} /> Tên tài xế: Phạm V
                      </p>
                      <p>
                        <FontAwesomeIcon icon={faPhone} /> Số điện
                        thoại:0332702119
                      </p>
                      <p>
                        <FontAwesomeIcon icon={faCar} /> Email: vang@gmail.com
                      </p>
                    </div>
